...
if __name__ == '__main__':
    ...
    # IP3 is initiated in the centre
    IP3.nodes[849].value=IP3_initial
    IP3.nodes[850].value=IP3_initial
    IP3.nodes[851].value=IP3_initial
    IP3.nodes[852].value=IP3_initial
