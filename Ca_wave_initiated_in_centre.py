...
if __name__ == '__main__':
	...
	#All species with initial concentrations are defined here in NEURON
    ...
    print 'Simulaiton Advanced :', simulation_time, 'ms i.e. initial states in which IP3 is initiated in the centre of the cylindre'   
    #for 3d figure ! 
